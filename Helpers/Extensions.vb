...
Public Module Extensions
    ...
    Public Function Name(token As Tokens) As String
        Select Case token
            ...
            Case Tokens.T_AssignAddition : Return "+="
            Case Tokens.T_AssignSubtraction : Return "-="
            Case Tokens.T_AssignMultiplication : Return "*="
            Case Tokens.T_AssignDivision : Return "/="
            Case Tokens.T_AssignModulus : Return "%="
